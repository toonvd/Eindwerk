...
(function(D,s,k){
    ...
    (function(a,c,b,e){
        function f(a){
            ...
            for(var d={},f,g;b;){
                f=a.data(b,t);
                for(g in f)if(f[g])d[g]=d.hasVirtualBinding=true;b=b.parentNode
                }
                return d
            }
            function g(){
        ...
        function h(b,d,g){
            ...
            if(!(h=g&&g[b])){
                ...
                if(g.search(/^touch/)!==-1&&(b=f(h),g=b.touches,b=b.changedTouches,g=g&&g.length?g[0]:b&&b.length?b[0]:e))for(h=0,len=u.length;h<len;h++)b=u[h],
                    c[b]=g[b];
        ...
        function m(a){
            G||(A||h("vmousecancel",a,d(a.target)),A=true,g())
            }
            function p(b){
            if(!G){
        ...
        if(!G){
            ...
            var b=d(a.target),c;
            h("vmouseup",a,b);
            if(!A&&(c=h("vclick",a,b))&&c.isDefaultPrevented())c=f(a).changedTouches[0],C.push({
                touchID:F,
                x:c.clientX,
                y:c.clientY
                }),z=true;
    ...
    function r(b){
        var b=
        a.data(b,t),d;
        if(b)for(d in b)if(b[d])return true;return false
        }
        function n(){}
    function k(b){
        var d=b.substr(1);
...
for(var I=0;I<c.length;I++)a.event.special[c[I]]=k(c[I]);
    ...
    if(d){
        ...
        for(e=f;e;){
            for(h=0;h<d;h++)if(z=C[h],e===f&&Math.abs(z.x-g)<threshold&&Math.abs(z.y-c)<threshold||a.data(e,x)===z.touchID){
                b.preventDefault();
                b.stopPropagation();
                return
            }
...
g=function(){
    ...
    a.browser.msie&&!o&&function(){
        var b,c;
        h.start=function(){
            if(!b)c=(c=a.fn[f].src)&&c+e(),b=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){
                c||k(e());
                g()
...
(function(a,c){
    ...
    a.fn.remove=function(b,d){
        return this.each(function(){
            d||(!b||a.filter(b,[this]).length)&&a("*",this).add([this]).each(function(){
...
a.widget=function(b,d,g){
    ...
    a[c][b].prototype=a.extend(true,d,{
        namespace:c,
        widgetName:b,
        widgetEventPrefix:a[c][b].prototype.widgetEventPrefix||b,
        widgetBaseClass:e
    },g);
    ...
    a.widget("mobile.widget",{
        ...
        _getCreateOptions:function(){
            ...
            a.each(this.options,function(a){
                var d=b.jqmData(a.replace(/[A-Z]/g,function(a){
...
(function(a,c){
...

    {
        ...
        nsNormalizeDict:b,
        nsNormalize:function(d){
            return!d?void 0:b[d]||(b[d]=a.camelCase(a.mobile.ns+d))
            },
...
a.mobile.browser.ie=function(){
    ...
    dynamicBaseTag:function(){
        ...
        c.length?e=c.attr("href"):c=d=a("<base>",{
            href:b
        }).appendTo("head");
    ...
    a.event.special.scrollstart={
        ...
        setup:function(){
            ...
            a(c).bind("touchmove scroll",
                function(c){
                    a.event.special.scrollstart.enabled&&(d||b(c,true),clearTimeout(f),f=setTimeout(function(){
                        b(c,false)
                        },50))
                    })
            }
...
(function(a,b){
    ...
    if(a.support.orientation&&(g=b.innerWidth||a(b).width(),h=b.innerHeight||a(b).height(),g=g>h&&g-h>50,h=t[b.orientation],g&&h||!g&&!h))t={
        "-90":true,
        90:true
    };
...
(function(a,c,b){
    var e=function(d){
        ...
        return function(b,f,e,o){
            ...
            b==="none",t=function(){
                a.mobile.pageContainer.toggleClass("ui-mobile-viewport-transitioning viewport-"+b)
                },x=function(){
                a.event.special.scrollstart.enabled=false;
                c.scrollTo(0,l);
                setTimeout(function(){
                ...
                o.removeClass(a.mobile.activePageClass+" out in reverse "+b).height("")
                },n=function(){
                o&&d&&u();
...
(function(a,c){
    function b(b){
        ...
        function d(){
        return s.innerHeight||a(s).height()
        }
        function g(){
...
isSameDomain:function(a,b){
    return l.parseUrl(a).domain===l.parseUrl(b).domain
    },
isRelativeUrl:function(a){
    return l.parseUrl(a).protocol===""
    },
...
clean:function(a){return a.replace(v.domain,"")},
    ...
    isExternal:function(a){a=l.parseUrl(a);return a.protocol&&a.domain!==w.domain?true:false},
    hasProtocol:function(a){return/^(:?\w+:)/.test(a)},
    isFirstPageUrl:function(b){var b=
...
isEmbeddedPage:function(a){
    ...
    directHashChange:function(b){
        ...
        a.each(n.stack,function(a,c){
            b.currentUrl===c.url&&(d=a<n.activeIndex,f=!d,e=a)
            });
...
x="&ui-state=dialog",u=p.children("base"),w=l.parseUrl(location.href),v=u.length?l.parseUrl(l.makeUrlAbsolute(u.attr("href"),w.href)):w,y=w.hrefNoHash!==v.hrefNoHash,B=a.support.dynamicBaseTag?{
    element:u.length?u:a("<base>",{
        href:v.hrefNoHash
        }).prependTo(p),
    set:function(a){
        B.element.attr("href",l.makeUrlAbsolute(a,v))
        },
    reset:function(){
        B.element.attr("href",v.hrefNoHash)
        }
    }:c;
...
m.bind(a.support.pushState?"popstate":"hashchange",function(){
    E=false
    });
m.one(a.support.pushState?"popstate":"hashchange",function(){
    E=true
    });
...
a.mobile.loadPage=function(b,d){
    ...
    if(g.length===0)if(a.mobile.firstPage&&l.isFirstPageUrl(u))a.mobile.firstPage.parent().length&&(g=a(a.mobile.firstPage));
    ...
    if(g.length){
        ...
        var m=e.pageContainer,x=new a.Event("pagebeforeload"),p={
        url:b,
        absUrl:k,
        dataUrl:n,
        deferred:f,
    ...
    if(e.showLoadMsg)var r=setTimeout(function(){
...
a.mobile.changePage=function(d,g){
    if(t)q.unshift(arguments);
        ...
        u.trigger(o,m);
        if(!o.isDefaultPrevented())if(d=m.toPage,t=true,typeof d=="string")a.mobile.loadPage(d,j).done(function(b,c,d,e){
            t=false;
            ...
            if(o&&o[0]===d[0]&&!j.allowSamePageTransition)t=false,u.trigger("pagechange",m);
                ...
                h(d,j.role);
                j.fromHashChange&&n.directHashChange({
                    currentUrl:p,
                    isBack:function(){
                        y=-1
                        },
            ...
            A&&r&&(p=(r.url||"")+x);
            if(j.changeHash!==false&&p)n.ignoreNextHashChange=true,
                l.set(p);
...
a.mobile._registerInternalEvents=function(){
    a(k).delegate("form","submit",function(b){
        ...
        if(a.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")&&c.jqmHijackable().length){
            ...
            !l.isExternal(f)&&!e&&(a.mobile.changePage(f,{
    ...
    if(a.mobile.linkBindingEnabled){
        ...
        if(f&&!(d.which>1)&&e.jqmHijackable().length){
            ...
            if(!a.mobile.ajaxEnabled&&!l.isEmbeddedPage(f))g();
                ...
                if(f.search("#")!=-1)if(f=f.replace(/[^#]*#/,""))f=l.isPath(f)?l.makeUrlAbsolute(f,h):l.makeUrlAbsolute("#"+f,w.hrefNoHash);
                    else{
                    d.preventDefault();
                    return
                }
                ...
                h||l.isExternal(f)&&!k?g():(g=e.jqmData("transition"),h=(h=e.jqmData("direction"))&&h==="reverse"||e.jqmData("back"),e=e.attr("data-"+
                    a.mobile.ns+"rel")||c,a.mobile.changePage(f,{
                    transition:g,
                    reverse:h,
                    role:e
                }),d.preventDefault())
...
a.mobile._handleHashChange=function(b){
    ...
    if(!a.mobile.hashListeningEnabled||n.ignoreNextHashChange)n.ignoreNextHashChange=false;
        ...
        if(n.stack.length>1&&d.indexOf(x)>-1)if(a.mobile.activePage.is(".ui-dialog"))n.directHashChange({
            currentUrl:d,
            either:function(b){
...
(function(a,c){
    ...
    onPopState:function(c){
        ...
        if(c){
            ...
            if(f=f!==h)e.one("hashchange.pushstate",function(){
...
(function(a){
    ...
    a(k).bind("pagecreate create",function(c){
        ...
        if(b)e=b.options,a(c.target).find("input").not(b.keepNativeSelector()).each(function(){
            var b=
    ...
    a.widget("mobile.dialog",a.mobile.widget,{
        ...
        _create:function(){
            var b=this,c=this.element,f=a("<a href='#' data-"+a.mobile.ns+
                "icon='delete' data-"+a.mobile.ns+"iconpos='notext'>"+this.options.closeBtnText+"</a>"),d=a("<div/>",{
                role:"dialog",
...
(function(a){
    a.fn.grid=function(c){
        return this.each(function(){
            ...
            if(!e)if(f.length<=5)for(var g in d)d[g]===f.length&&(e=g);else e="a";
            d=d[e];
    ...
    var e=function(){
        ...
        a(k).bind({
            "vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart":function(e){
                ...
                if(k.length)if(j=k.attr("data-"+a.mobile.ns+"theme"),e==="vmousedown")a.support.touch?d=setTimeout(function(){
                    k.removeClass("ui-btn-up-"+j).addClass("ui-btn-down-"+j)
                    },c):k.removeClass("ui-btn-up-"+j).addClass("ui-btn-down-"+j);
                    else if(e==="vmousecancel"||e==="vmouseup")k.removeClass("ui-btn-down-"+j).addClass("ui-btn-up-"+j);
                    else if(e==="vmouseover"||e==="focus")a.support.touch?g=setTimeout(function(){
                    k.removeClass("ui-btn-up-"+j).addClass("ui-btn-hover-"+j)
...
(function(a){
    a.widget("mobile.collapsible",a.mobile.widget,{
        ...
        _create:function(){
            ...
            f.insertBefore(d).addClass("ui-collapsible-heading").append("<span class='ui-collapsible-heading-status'></span>").wrapInner("<a href='#' class='ui-collapsible-heading-toggle'></a>").find("a").first().buttonMarkup({
                shadow:false,
                corners:false,
            ...
            e.bind("expand collapse",function(c){
                if(!c.isDefaultPrevented()){
                    ...
                    if(k&&(!g.length||e.jqmData("collapsible-last")))f.find("a").first().add(f.find(".ui-btn-inner")).toggleClass("ui-corner-bottom",
...
(function(a,c){
    a.widget("mobile.collapsibleset",a.mobile.widget,{
        ...
        refresh:function(){
            ...
            c.each(function(){
                a(this).find(a.mobile.collapsible.prototype.options.heading).find("a").first().add(".ui-btn-inner").removeClass("ui-corner-top ui-corner-bottom")
                });
...
(function(a,c){
    a.widget("mobile.navbar",a.mobile.widget,{
        ...
        _create:function(){
            ...
            b.addClass("ui-navbar").attr("role","navigation").find("ul").jqmEnhanceable().grid({
            ...
            b.delegate("a","vclick",function(b){
                a(b.target).hasClass("ui-disabled")||(e.removeClass(a.mobile.activeBtnClass),a(this).addClass(a.mobile.activeBtnClass))
                });
...
(function(a){
    ...
    a.widget("mobile.listview",a.mobile.widget,{
        ...
        _create:function(){
            ...
            this.element.addClass(function(c,f){
                return f+" ui-listview "+a
                });
            this.refresh(true)
            },
        ...
        _addThumbClasses:function(b){
            var c,f,d=b.length;
            for(c=0;c<d;c++)f=a(this._findFirstElementByTagName(b[c].firstChild,"nextSibling","img","IMG")),f.length&&(f.addClass("ui-li-thumb"),a(this._findFirstElementByTagName(f[0].parentNode,
        ...
        refresh:function(b){
            ...
            if(!c.theme)c.theme=a.mobile.getInheritedTheme(this.element,
                "c");
            for(var u=0,w=j.length;u<w;u++){
                p=j.eq(u);
                l="ui-li";
                if(b||!p.hasClass("ui-li"))r=p.jqmData("theme")||c.theme,n=this._getChildrenByTagName(p[0],"a","A"),n.length?(t=p.jqmData("icon"),p.buttonMarkup({
                    wrapperEls:"div",
                    shadow:false,
                    corners:false,
                    iconpos:"right",
                    icon:n.length>1||t===false?false:t||"arrow-r",
                    theme:r
                }),t!=false&&n.length==1&&p.addClass("ui-li-has-arrow"),n.first().removeClass("ui-link").addClass("ui-link-inherit"),n.length>1&&(l+=" ui-li-has-alt",n=n.last(),q=g||n.jqmData("theme")||
                    c.splitTheme,x=n.jqmData("icon"),n.appendTo(p).attr("title",n.getEncodedText()).addClass("ui-li-link-alt").empty().buttonMarkup({
                        shadow:false,
                        corners:false,
                        theme:r,
                        icon:false,
                        ...
                        theme:q,
                        iconpos:"notext",
                        icon:x||t||h||c.splitIcon
                        })))):p.jqmData("role")==="list-divider"?(l+=" ui-li-divider ui-bar-"+d,p.attr("role","heading"),o&&(o=1)):l+=" ui-li-static ui-body-"+r;
                ...
                for(l in m)a(m[l]).addClass(l).children(".ui-btn-inner").addClass(l);f.find("h1, h2, h3, h4, h5, h6").addClass("ui-li-heading").end().find("p, dl").addClass("ui-li-desc").end().find(".ui-li-aside").each(function(){
                var b=a(this);
...
_getInputSet:function(){
    return this.inputtype==="checkbox"?this.element:this.element.closest("form,fieldset,:jqmData(role='page')").find("input[name='"+this.element[0].name+"'][type='"+this.inputtype+"']")
    },
_updateAll:function(){
    var b=this;
    this._getInputSet().each(function(){
    ...
    a.widget("mobile.button",a.mobile.widget,{
        ...
        _create:function(){
            ...
            if(b[0].tagName==="A")!b.hasClass("ui-btn")&&b.buttonMarkup();
                ...
                e=this.button=a("<div></div>").text(b.text()||b.val()).insertBefore(b).buttonMarkup({
                    theme:f.theme,
                    icon:f.icon,
                    iconpos:f.iconpos,
                    inline:f.inline,
                    corners:f.corners,
                    shadow:f.shadow,
                    iconshadow:f.iconshadow,
                    mini:f.mini
                    }).addClass(d).append(b.addClass("ui-btn-hidden"));
                f=b.attr("type");
                d=b.attr("name");
...
(function(a){
    a.fn.controlgroup=function(c){
        function b(a,b){
            a.removeClass("ui-btn-corner-all ui-shadow").eq(0).addClass(b[0]).end().last().addClass(b[1]).addClass("ui-controlgroup-last")
            }
            return this.each(function(){
    ...
    a.widget("mobile.slider",a.mobile.widget,{
        ...
        _create:function(){
            ...
            if(g=="select"){
                ...
                u=e.find("option");
                d=0;
                for(h=u.length;d<h;d++)o=!d?"b":"a",n=!d?" ui-btn-down-"+f:" "+a.mobile.activeBtnClass,k.createElement("div"),q=k.createElement("span"),q.className=["ui-slider-label ui-slider-label-",o,n," ui-btn-corner-all"].join(""),q.setAttribute("role","img"),q.appendChild(k.createTextNode(u[d].innerHTML)),
                    a(q).prependTo(w);
                b._labels=a(".ui-slider-label",w)
                }
                j.addClass("ui-slider");
            e.addClass(g==="input"?"ui-slider-input":"ui-slider-switch").change(function(){
                b.mouseMoved||b.refresh(m(),true)
                }).keyup(function(){
            ...
            a(k).bind("vmousemove",function(a){
                if(b.dragging)return b.mouseMoved=true,g==="select"&&x.removeClass("ui-slider-handle-snapping"),b.refresh(a),b.userModified=b.beforeStart!==e[0].selectedIndex,false
                    });
            ...
            w.add(k).bind("vmouseup",function(){
                if(b.dragging)return b.dragging=false,g==="select"&&(x.addClass("ui-slider-handle-snapping"),b.mouseMoved?b.userModified?b.refresh(b.beforeStart==0?1:0):b.refresh(b.beforeStart):b.refresh(b.beforeStart==0?1:0)),b.mouseMoved=false
                    });
            w.insertAfter(e);
...
refresh:function(b,c,f){
    ...
    if(!isNaN(b)){
        ...
        this.handle.attr({
            "aria-valuenow":g==="input"?m:d.find("option").eq(m).attr("value"),
            "aria-valuetext":g==="input"?m:d.find("option").eq(m).getEncodedText(),
            title:g==="input"?m:d.find("option").eq(m).getEncodedText()
            });
    ...
    a.widget("mobile.selectmenu",a.mobile.widget,{
        ...
        _create:function(){
            ...
            var c=this,b=this.options,e=this.button.text(a(this.select[0].options.item(this.select[0].selectedIndex==
                -1?0:this.select[0].selectedIndex)).text()).insertBefore(this.select).buttonMarkup({
                theme:b.theme,
                icon:b.icon,
                iconpos:b.iconpos,
                inline:b.inline,
        ...
        setButtonText:function(){
            ...
            this.button.find(".ui-btn-text").text(function(){
                return!c.isMultiple?
                b.text():b.length?b.map(function(){
                    return a(this).text()
...
(function(a){
    var c=function(b){
        var c=b.selectID,f=b.label,d=b.select.closest(".ui-page"),g=a("<div>",{
            "class":"ui-selectmenu-screen ui-screen-hidden"
        }).appendTo(d),h=b._selectOptions(),j=b.isMultiple=b.select[0].multiple,o=c+"-button",m=c+"-menu",p=a("<div data-"+a.mobile.ns+"role='dialog' data-"+a.mobile.ns+"theme='"+b.options.theme+"' data-"+a.mobile.ns+"overlay-theme='"+b.options.overlayTheme+"'><div data-"+a.mobile.ns+
            "role='header'><div class='ui-title'>"+f.getEncodedText()+"</div></div><div data-"+a.mobile.ns+"role='content'></div></div>"),l=a("<div>",{
            ...
            }).insertAfter(g),r=a("<ul>",{
            "class":"ui-selectmenu-list",
            id:m,
            role:"listbox",
            "aria-labelledby":o
        }).attr("data-"+a.mobile.ns+"theme",b.options.theme).appendTo(l),n=a("<div>",{
        ...
        b.isMultiple&&(t=a("<a>",{
            ...
            href:"#",
            "class":"ui-btn-left"
        }).attr("data-"+a.mobile.ns+"iconpos","notext").attr("data-"+a.mobile.ns+"icon","delete").appendTo(n).buttonMarkup());
        a.extend(b,{
            select:b.select,
            selectID:c,
            buttonId:o,
        ...
        open:function(){
            function b(){
                c.list.find("."+a.mobile.activeBtnClass+" a").focus()
                }
                ...
                if(f>h-80||!a.support.scrollTop){
                    ...
                    if(g==0&&j>h)c.thisPage.one("pagehide",function(){
...
(function(a){
    a.widget("mobile.fixedtoolbar",a.mobile.widget,{
        ...
        _bindPageEvents:function(){
            ...
            c.element.closest(".ui-page").bind("pagebeforeshow",function(){
                ...
                function(){
                    b.updatePagePadding&&c.updatePagePadding()
                    }).bind("pageshow",function(){
                c.updatePagePadding();
                b.updatePagePadding&&a(s).bind("throttledresize."+c.widgetName,function(){
                    c.updatePagePadding()
                    })
                ...
                if(b.trackPersistentToolbars){
                    ...
                    if(h.length||j.length)h.add(j).appendTo(a.mobile.pageContainer),f.nextPage.one("pageshow",function(){
                        h.add(j).appendTo(this)
                        })
                    }
                    })
        },
    ...
    hide:function(a){
        ...
        this._useTransition(a)?b.addClass(e).removeClass("in").animationComplete(function(){
            b.addClass("ui-fixed-hidden").removeClass(e)
            }):b.addClass("ui-fixed-hidden").removeClass(e);
        this._visible=false
        },
    toggle:function(){
    ...
    _bindToggleHandlers:function(){
        var c=this,b=c.options;
        c.element.closest(".ui-page").bind("vclick",function(e){
            b.tapToggle&&!a(e.target).closest(b.tapToggleBlacklist).length&&c.toggle()
            }).bind("focusin focusout",
            function(e){
                if(screen.width<500&&a(e.target).is(b.hideDuringFocus)&&!a(e.target).closest(".ui-header-fixed, .ui-footer-fixed").length)c[e.type==="focusin"&&c._visible?"hide":"show"]()
                    })
        },
    destroy:function(){
...
(function(a,c){
    function b(){
        ...
        h.css({
            top:a.support.scrollTop&&g.scrollTop()+g.height()/2||b.length&&b.offset().top||100
            })
        }
        function e(){
        var c=h.offset(),d=g.scrollTop(),f=a.mobile.getScreenHeight();
        if(c.top<d||c.top-d>f)h.addClass("ui-loader-fakefix"),b(),g.unbind("scroll",
            e).bind("scroll",b)
            }
            function f(){
        d.removeClass("ui-mobile-rendering")
        }
        var d=a("html");
    a("head");
    var g=a(c);
